...
(function () {
    ...
    var _loadinfo = () => {
        ...
        fetch(apiUrl)
            ...
            .then(ret => {
                ...
                if (_title.value.length < 1) _title.value = ret.title;

                if (_tags.value.length < 1) _tags.value = ret.meta;

                if (_url.value !== ret.longurl) _url.value = ret.longurl;
            });
    };
    ...
    // DOM elements dont have [].forEach()
