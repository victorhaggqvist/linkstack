...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7); // eslint-disable-line no-unused-vars
	var ReactDOM = __webpack_require__(166);
	// eslint-disable-line no-unused-vars

	ReactDOM.render(React.createElement(_Dashboard.Dashboard, null), document.getElementById('mount'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LinkList = __webpack_require__(2);

	var _PushForm = __webpack_require__(164);
	    ...
	    _createClass(Dashboard, [{
	        ...
	        value: function loadRecets() {
	            ...
	            fetch('/api/items', {
	                ...
	                _this2.setState({ list: items });
	            });
	        }
	    }, {
	        key: 'popLink',
	        value: function popLink(id) {
	            this.setState({ list: this.state.list.filter(function (i) {
	                    return i.id != id;
	                }) });
	        }
	    }, {
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(_PushForm.PushForm, { onPushed: function onPushed() {
	                                    return _this3.loadRecets();
	                                } })
	                        )
	                    )
	                ),
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(_LinkList.LinkList, { list: this.state.list, onPopedLink: this.popLink.bind(this) })
	                        )
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinkList = exports.LinkList = function (_React$Component) {
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'tbody',
	                    null,
	                    this.props.list.map(function (l) {
	                        return React.createElement(Link, _extends({ key: l.id }, l, { onPopedLink: _this2.props.onPopedLink.bind(_this2) }));
	                    })
	                )
	            );
	        }
	...
	var Link = function (_React$Component2) {
	    ...
	    function Link(props) {
	        ...
	        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(Link).call(this, props));
	    ...
	    _createClass(Link, [{
	        ...
	        value: function deleteLink() {
	            ...
	            fetch('/api/items/' + this.props.id, {
	                ...
	                if (resp.status === 204) {
	                    _this4.setState({ isDeleting: false });
	                    _this4.props.onPopedLink(_this4.props.id);
	                }

	                _log.log.info(resp);
	            }, function (err) {
	                return _log.log.error(err);
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var editUrl = '/stack/' + this.props.id;
	            var favicon = React.createElement('img', { src: 'https://www.google.com/s2/favicons?domain=' + this.props.url, alt: 'favicon' });

	            var buttonClasses = 'btn btn-default btn-sm delete-btn icon-button';
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'a',
	                        { href: this.props.url },
	                        truncate(this.props.url, 70)
	                    )
	                ),
	                React.createElement(
	                    'td',
	                    { title: this.props.title },
	                    truncate(this.props.title, 70)
	                ),
	                React.createElement(
	                    'td',
	                    { title: this.props.tags.reduce(function (a, b) {
	                            return a + ', ' + b;
	                        }) },
	                    truncate(this.props.tags.reduce(function (a, b) {
	                        return a + ', ' + b;
	                    }), 40)
	                ),
	                React.createElement(
	                    'td',
	                    { className: 'date' },
	                    this.props.created.substring(0, 16)
	                ),
	                React.createElement(
	                    'td',
	                    { className: 'action' },
	                    React.createElement(
	                        'button',
	                        { type: 'button', className: buttonClasses, onClick: this.deleteLink.bind(this) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var log = exports.log = __webpack_require__(4);

	if (false) log.setDefaultLevel(log.levels.TRACE);else log.setDefaultLevel(log.levels.SILENT);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	(function (root, definition) {
	    ...
	    } else if ("function" === 'function' && _typeof(__webpack_require__(6)) === 'object') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PushForm = undefined;

	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

	var _LoadingInput = __webpack_require__(165);
	...
	if (false) METASERVICE = 'https://rock-sorter-825.appspot.com/get?url=https://tool.stack.snilius.com';

	var PushForm = exports.PushForm = function (_React$Component) {
	    _inherits(PushForm, _React$Component);

	    function PushForm(props) {
	        _classCallCheck(this, PushForm);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PushForm).call(this, props));
	    ...
	    _createClass(PushForm, [{
	        key: 'onUrlChange',
	        value: function onUrlChange(event) {
	            var _this2 = this;

	            this.setState({ url: event.target.value }, function () {
	                if (!_this2.state.isLoadingInfo) {
	                    if (_this2.state.url.length < 5) return;

	                    // don't refetch info
	                    if (!(_this2.state.title.length < 1 || _this2.state.tags.length < 1)) return;

	                    _this2.setState({ isLoadingInfo: true }, function () {
	                        var apiUrl = METASERVICE + '/info?url=' + _this2.state.url;
	                        fetch(apiUrl).then(function (resp) {
	                            return resp.json();
	                        }, function (err) {
	                            _this2.setState({ isLoadingInfo: false });
	                            _log.log.debug('meta fetch fail');
	                            _log.log.debug(err);
	                        }).then(function (ret) {
	                            if (ret === undefined) return;
	                            _this2.setState({ isLoadingInfo: false });

	                            if (_this2.state.title.length < 1) _this2.setState({ title: ret.title });

	                            if (_this2.state.tags.length < 1) _this2.setState({ tags: ret.meta });

	                            if (_this2.state.url !== ret.longurl) _this2.setState({ url: ret.longurl });

	                            _this2.setState({ tagsValue: _this2.state.tags.reduce(function (a, b) {
	                                    return a == null ? b : a + ', ' + b;
	                                }, null) });
	                        });
	                    });
	        ...
	        value: function push() {
	            ...
	            fetch('/api/items', {
	                ...
	                cosole.log(err);
	                _this3.setState({ buttonText: 'Push', isPushing: false });
	            }).then(function (json) {
	                if ('message' in json) {
	                    _this3.setState({ status: json.message });
	                } else {
	                    _this3.setState({ status: null, title: '', tagsValue: '', url: '' });
	                    _log.log.info(json);
	                }
	                _this3.setState({ buttonText: 'Push', isPushing: false });
	                _this3.props.onPushed();
	            }, function (err) {
	                _log.log.error(err);
	            });
	        }
	        ...
	        value: function render() {
	            ...
	            if (this.state.status !== null) {
	                status = React.createElement(
	                    'div',
	                    { className: 'alert alert-info', role: 'alert', id: 'status' },
	                    React.createElement(
	                        'button',
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'label',
	                        { className: 'control-label col-lg-2 required', htmlFor: 'title' },
	                        'Title'
	                    ),
	                    React.createElement(
	                        'div',
	                ...
	                React.createElement(_LoadingInput.LoadingInput, { id: 'url', label: 'Url', value: this.state.url,
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'label',
	                        { className: 'control-label col-lg-2', htmlFor: 'tags' },
	                        'Tags'
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'col-lg-10' },
	                        React.createElement('input', { type: 'text', id: 'tags',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoadingInput = exports.LoadingInput = function (_React$Component) {
	    _inherits(LoadingInput, _React$Component);

	    function LoadingInput() {
	        _classCallCheck(this, LoadingInput);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(LoadingInput).apply(this, arguments));
	    }

	    _createClass(LoadingInput, [{
	        key: "render",
	        value: function render() {
	            if (this.props.loading) {
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        "label",
	                        { className: "control-label col-lg-2 required", htmlFor: this.props.id },
	                        this.props.label
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: "col-lg-10" },
	                        React.createElement("input", { type: "text", id: "title", required: "required", autoComplete: "off",
	                            value: this.props.value,
	                            className: "form-control", onChange: this.props.onChange.bind(this) }),
	                        React.createElement("span", { className: "glyphicon glyphicon-repeat form-control-feedback",
	                ...
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "col-lg-10" },
	                        React.createElement("input", { type: "text", id: this.props.id, required: "required", autoComplete: "off",
	                            value: this.props.value,
	                            className: "form-control", onChange: this.props.onChange.bind(this) })
	                    )
	                );
